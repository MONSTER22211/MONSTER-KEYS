...
# ---------------------------------------------------------------------------
#  PORT — LOCKED TO 8080 FOR RAILWAY.APP CONSISTENCY.
#
#  Railway.app:
#    - Injects $PORT=8080 by default when you create a Service Domain
#    - We configured the Service Domain Target Port = 8080 in Networking
#  So gunicorn/Flask bind to 8080 and traffic always matches.
#  (You can still override via LICENSE_PORT env var if needed, but 8080 is the default.)
# ---------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    print(f" Validate URL   : POST /api/app/validate")
    print(f" Download URL   : GET  /api/app/download/<tier>?token=...")
    print(f" Health URL     : GET  /api/app/health")
